  ...
  function srcApp_servicesCommonServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CommonService = /*#__PURE__*/function () {
      function CommonService(http) {
        ...
        this.http = http;
        this.API_URL = 'https://resume-server-app.herokuapp.com'; // private API_URL = 'http://localhost:4800';

        this.EMAIL = 'ahsanjutt0999@outlook.com';

        this.getEducation = function () {
          return _this.http.get("".concat(_this.API_URL, "/edu/EducationByUserId/").concat(_this.getUserId()));
        };

        this.getExperience = function () {
          return _this.http.get("".concat(_this.API_URL, "/work/workByUserId/").concat(_this.getUserId()));
        };

        this.getProjects = function () {
          return _this.http.get("".concat(_this.API_URL, "/project/projectByUserId/").concat(_this.getUserId()));
        };

        this.sendMsg = function (body) {
          return _this.http.post("".concat(_this.API_URL, "/contact/postContact"), body);
        };
      } // loginIn() {
      ...
      _createClass(CommonService, [{
        ...
        value: function getProfile() {
          return this.http.get("".concat(this.API_URL, "/getUserByEmail/").concat(this.EMAIL)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
